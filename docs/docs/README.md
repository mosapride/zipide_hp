...
Youtubeやブログなどで、自作PCにMac OSをインストールする手順が載っています。この行為はソフトウェアライセンス契約に違反になります。Mac OSは、Appleが販売しているPCつまり、Macシリーズにしか使用する許可がされていません。自作PCにMac OSをインストールしないようにしましょう。
